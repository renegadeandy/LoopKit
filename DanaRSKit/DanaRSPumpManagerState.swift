//
//  DanaRSPumpManagerState.swift
//  DanaRSKit
//
//  Created by Andy Armstrong on 11/5/21.
...
public struct DanaRSPumpManagerState: RawRepresentable, Equatable {
    public static func == (lhs: DanaRSPumpManagerState, rhs: DanaRSPumpManagerState) -> Bool {
  ...
  //  public var rileyLinkConnectionManagerState: RileyLinkConnectionManagerState?
    ...
    public var rawValue: RawValue {
        var value: [String : Any] = [
            ...
            "version": DanaRSPumpManagerState.version,
